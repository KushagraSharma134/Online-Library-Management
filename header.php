...
<body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
	...
	?>
               <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="index.php" class="navbar-brand">Online Library Management</a>
               </div>
	<?php
	}
	?>
...
?>
	...
	?>
	  ...
	  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Users<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="student.php">Add student/teacher</a></li>
          <li><a href="viewstudent.php">View student/teacher</a></li>
        </ul>
...
?>
	  ...
	  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Student<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="addstudent.php">Add student/teacher</a></li>
          <li><a href="viewstudent.php">View student/teacher</a></li>
        </ul>		
      </li>
