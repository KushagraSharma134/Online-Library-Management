...
if(isset($_POST['submit']))
{
	...
	else
	{
		...
		if(mysqli_affected_rows($con) ==1)
		{
			echo "<script>alert('Student/Teacher Registration done successfully..');</script>";
          ...
          <div class="container">
               <div class="row">
					...
					?>
								   ...
								   <input type="text" name="rollno" class="form-control" placeholder="Roll number/Teacher ID"><span class="err" id="idrollno"></span>
